...
def test_add_item_as_seller(client: TestClient,
    ...
    assert response_item.category == category
    ...
    assert item_in_database.category == category
...
#     assert updated_item.category == updated_category
